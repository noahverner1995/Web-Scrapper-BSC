# Web-Scrapper-BSC
Here's a simple Python program that takes the current first Top 100 Wallets by BNB balance from **BscScan** and filters them using a condition in their Txn Count value, for then exporting them as a dataframe in a csv file.
